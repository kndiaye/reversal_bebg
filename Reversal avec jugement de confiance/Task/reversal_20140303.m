...
try
    ...
    switch machine
        ...
        case 'puma-ndiaye.lan'
            [w, wRect]=Screen('OpenWindow', screenId, 0, [0 0 800 600]);
        otherwise
            [w, wRect]=Screen('OpenWindow', screenId, 2, []);
            consdir=fullfile(fileparts(mfilename('fullpath')),'Consignes');
    end
    ...
    %Expe('Main',Nom,machine,w,wRect,wW,wH,black,white,colbg,1000,[30/100 60/100], 5,5, 25,2000,50,4000,2000);

    Expe('Main',Nom,machine,w,wRect,wW,wH,black,white,colbg,1000,[20/100 80/100], 5,5, 25,2000,50,4000,2000);
...
switch data.hostname
    ...
    otherwise
        stimdir=fullfile(fileparts(mfilename('fullpath')),'..', 'stimuli');      
end
...
if Etape(1)=='M'
    ...
    Screen('DrawText', w,'Veuillez patienter',50, 100, [0 0 0]);
